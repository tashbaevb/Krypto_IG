...
Die EU folgt gegenüber Kryptowährungen einer Schutzlogik. Da die Geldpolitik in der Eurozone bei der Europäischen Zentralbank (EZB) liegt, könnte eine breite Nutzung privater Kryptowährungen als Zahlungsmittel die geldpolitische Steuerung, die Finanzstabilität und die Kontrolle über Zahlungsströme schwächen.
...
Die empirischen Daten im Euroraum zeigen eine Lücke zwischen Besitz und Zahlungsnutzung. Auf Basis des SPACE Survey 2022 mit 39.507 Erwachsenen aus 17 Ländern des Euroraums zeigt Zamora-Pérez, dass jüngere Gruppen häufiger Krypto-Assets besitzen, die Nutzung als Zahlungsmittel jedoch in allen Altersgruppen niedriger bleibt als der Besitz~\cite{Zamora2026}.
Abbildung~\ref{fig:krypto-besitz-zahlung-eu} im Anhang bestätigt, dass Krypto-Assets im Euroraum eher als Anlage oder Spekulationsobjekt verstanden werden und nur begrenzt als alltägliches Zahlungsmittel dienen. Dabei ist zu beachten, dass die Daten auf Selbstauskünften beruhen und nicht jede einzelne Transaktion messen~\cite{Zamora2026}. Der EU-Fall zeigt damit, dass Regulierung Krypto-Assets nicht automatisch zu Geld macht und das Vertrauen der Nutzer für alltägliche Zahlungen bisher nicht ausreicht.
